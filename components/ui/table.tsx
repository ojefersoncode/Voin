...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-tfont-medium [&>tr]:last:border-b-0 bg-[#181818] hover:bg-[#212121]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-gray-700 transition-colors bg-[#181818] hover:bg-[#212121] data-[state=selected]:bg-zinc-100 dark:data-[state=selected]:bg-zinc-800',
      className
    )}
    {...props}
  />
